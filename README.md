[![Run App Auman](https://github.com/kauman3/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/kauman3/GithubActions/actions/workflows/run-app.yaml)
